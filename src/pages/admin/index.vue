<template>
  <div>
    <div class="site-info">
      <div class="sub-container shadow">
    ...
    <div class="chart-wrap">
      <div ref="articleCategory" class="sub-container shadow">
        <h2>文章分类</h2>
        <div id="article-chart" class="chart"></div>
      </div>
      <div ref="users" v-if="isMaster" class="sub-container shadow">
        <h2>用户</h2>
        <div id="user-chart" class="chart"></div>
      </div>
      <div ref="illegalInfo" v-if="isMaster" class="sub-container shadow">
        <h2>未处理举报信息</h2>
