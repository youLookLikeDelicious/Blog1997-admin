describe('Test friend link', () => {
    before(() => {
        ...
        cy.intercept('get', Cypress.env('api_url') + '/admin/friend-link', { fixture: 'friend-link' })
    })
    ...
    it('Test store new friend link', () => {
        cy.intercept('post', Cypress.env('api_url') + '/admin/friend-link', { fixture: 'friend-link-store' })
    ...
    it('Test update friend link', () => {
        cy.intercept('post', Cypress.env('api_url') + '/admin/friend-link/11', { fixture: 'friend-link-update' }).as('friend-link-update')
    ...
    it('Test destroy friend link', () => {
        cy.intercept('post', Cypress.env('api_url') + '/admin/friend-link/11', { fixture: 'friend-link-destroy' }).as('friend-link-destroy')
    ...
    it('Test search friend link', () => {
        cy.intercept('get', Cypress.env('api_url') + '/admin/friend-link?name=blog', { fixture: 'friend-link-search' }).as('friend.link.search')
