describe('Test sensitive category', () => {
    before(() => {
        ...
        cy.intercept('get', Cypress.env('api_url') + '/admin/sensitive-word-category', { fixture: 'sensitive-word-category' })
    })
    ...
    it('Test modify category', () => {
        cy.intercept('post', Cypress.env('api_url') + '/admin/sensitive-word-category/15', { fixture: 'sensitive-word-category-update' }).as('sensitive-word-category-update')
    ...
    it('Test destroy category', () => {
        cy.intercept('post', Cypress.env('api_url') + '/admin/sensitive-word-category/15', { fixture: 'sensitive-word-category-destroy' }).as('sensitive-word-category-destroy')
     ...
     */
    it('Test search', () => {
        cy.intercept('get', Cypress.env('api_url') + '/admin/sensitive-word-category?name=%E9%AB%98%E5%85%B4&rank=2', { fixture: 'sensitive-word-category-search' })
