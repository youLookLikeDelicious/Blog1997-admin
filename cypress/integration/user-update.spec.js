describe('Test log', () => {
  ...
  it('Visit page', () => {
    cy.intercept('get', Cypress.env('api_url') + '/user/profile', { fixture: 'user-profile' }).as('user.profile')
    cy.visit(Cypress.env('host') + '/profile')
  ...
  /**
     ...
     */
  it('Test change name', () => {
    cy.intercept('post', Cypress.env('api_url') + '/user/update/2', { fixture: 'user-update-name' }).as('user.update.name')
  ...
  it('Test change email', () => {
    cy.intercept('post', Cypress.env('api_url') + '/user/update/2', { fixture: 'user-update-email' }).as('user.update.email')
