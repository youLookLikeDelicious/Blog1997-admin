describe('Test sensitive word', () => {
  ...
  /**
     ...
     */
  it('Test add word', () => {
    cy.intercept('post', Cypress.env('api_url') + '/admin/sensitive-word', { fixture: 'sensitive-word-store' })
    cy.wait(300)
  ...
  /**
     ...
     */
  it('Test update word', () => {
    cy.intercept('post', Cypress.env('api_url') + '/admin/sensitive-word/3290', { fixture: 'sensitive-word-update' }).as('sensitive.word.update')
  ...
  it('Test destroy word', () => {
    cy.intercept('post', Cypress.env('api_url') + '/admin/sensitive-word/971', { fixture: 'sensitive-word-destroy' }).as('sensitive.word.destroy')
  ...
  /**
     ...
     */
  it('Test import word', () => {
    cy.intercept('post', Cypress.env('api_url') + '/admin/sensitive-word/import', { fixture: 'sensitive-word-import' })
    cy.intercept('get', Cypress.env('api_url') + '/admin/sensitive-word?category_id=12', { fixture: 'sensitive-word-search' }).as('sensitive.word.search')
    ...
    cy.get('.import-sensitive-word input[type=file]').selectFile('sensitive-word/word')
