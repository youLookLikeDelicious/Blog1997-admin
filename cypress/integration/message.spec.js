describe('Test message manager', () => {
    before(() => {
        ...
        cy.intercept('get', Cypress.env('api_url') + '/admin/illegal-info', {
    ...
    it('Test ignore report', () => {
        cy.intercept('post', Cypress.env('api_url') + '/admin/illegal-info/ignore/5', {
    ...
    it('Test approve report', () => {
        cy.intercept('post', Cypress.env('api_url') + '/admin/illegal-info/approve/7', {
    ...
    it('Test comments', () => {
        ...
        // 评论审批通过
        cy.intercept('post', Cypress.env('api_url') + '/admin/comment/approve', {
    ...
    it('Test notification', () => {
        cy.intercept('get', Cypress.env('api_url') + '/admin/notification', {
